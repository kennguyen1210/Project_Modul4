...
@Component
public class CatalogEditValidate implements Validator {
    @Autowired
    ...
    public void validate(Object target, Errors errors) {
        ...
        } else if (!catalogService.findById(cat.getCatalogId()).getCatalogName().equals(cat.getCatalogName()) && catalogService.checkExistByName(cat.getCatalogName())) {
